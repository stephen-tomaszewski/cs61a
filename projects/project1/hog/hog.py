...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    if player_score >= 100:
        player_tens, player_ones = (player_score // 10) % 10, player_score % 10
        opponent_tens, opponent_ones = opponent_score // 10, opponent_score % 10
    elif opponent_score >= 100:
        player_tens, player_ones = player_score // 10, player_score % 10
        opponent_tens, opponent_ones = (opponent_score // 10) % 10, opponent_score % 10
    else:
        player_tens, player_ones = player_score // 10, player_score % 10
        opponent_tens, opponent_ones = opponent_score // 10, opponent_score % 10

    if abs(player_tens - player_ones) == abs(opponent_tens - opponent_ones):
        return True
    else:
        return False
    # END PROBLEM 4
